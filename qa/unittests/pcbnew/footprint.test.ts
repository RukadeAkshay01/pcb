...
// Sweep the library the Footprint Editor actually bundles (kicad/public):
// every real KiCad 9 footprint the editor can open must parse and round-trip.
const BUNDLED = new URL('../../../kicad/public/footprints/CM5IO.pretty', import.meta.url).pathname;
