...
describe('placeSymbol', () => {
  ...
  it('adds the instance and embeds the library def, and undoes both', () => {
    const empty = { version: 1, libSymbols: [], symbols: [], lines: [], junctions: [], noConnects: [], labels: [], sheets: [], busEntries: [], images: [], graphics: [], textBoxes: [], source: parse('(kicad_sch (version 1))') } as const;
