...
import type { PcbFootprint } from '../src/pcb/types.js';
...
// Sweep the library the Footprint Editor actually bundles (apps/studio/public):
// every real KiCad 9 footprint the editor can open must parse and round-trip.
const BUNDLED = new URL('../../../apps/studio/public/footprints/CM5IO.pretty', import.meta.url).pathname;
