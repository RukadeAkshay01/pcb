...
import type { Schematic, SchSymbol, SchLine, SchJunction, SchNoConnect, SchLabel, SchSheet, SchBusEntry, SchImage, SchTextBox, SchTable, LibGraphic, LibSymbol, Vec2 } from '../model/types.js';
